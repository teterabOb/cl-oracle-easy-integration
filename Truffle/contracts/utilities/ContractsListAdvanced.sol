...
library ContractsListAdvanced {
    string public constant AVAX_USD_NAME = "AVAX / USD";
    string public constant BTC_ETH_NAME  = "BTC / ETH";
    string public constant BTC_USD_NAME  = "BTC / USD";
    string public constant ETH_USD_NAME  = "ETH / USD";
    string public constant LINK_ETH_NAME = "LINK / ETH";
    string public constant LINK_USD_NAME = "LINK / USD";
    string public constant USDT_USD_NAME = "USDT / USD";
